...
bit_string, _ = gen.generate(10, extract_mode='flatten')
bit_string = bit_string[:mass_length]
print("Generated length:", len(bit_string))
...
d_res = run_dieharder(bit_string)
print("Diehard:", d_res['passed'], "/", d_res['total'])
